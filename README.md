...
| MDAnalysis | all                 | any          | MDAnalysis does not check connectivity.  (However, calculating values of improper torsions assumes the central atom is first.) When guessing impropers from bonds, the central atom can be first or last.                            |
